...
void ApplicationUI::onSystemLanguageChanged()
{
    ...
    QString file_name = QString("QExpress_%1").arg(locale_string);
...
void ApplicationUI::resendNotification()
{
    ...
    request.setTarget("com.example.QExpressService");
    request.setAction("com.example.QExpressService.RESET");
